OC.L10N.register(
    ...
    "Include groups" : "Gruppen einschliessen",
    "Exclude groups" : "Gruppen ausschliessen",
    "\n\t\t                    If include is selected, just the groups in this field need to do 2FA.\n\t\t                " : "\nWenn Einschliessen ausgewählt, müssen nur die Gruppen in diesem Feld die Zwei-Faktor-Authentifizierung verwenden.",
    "\n\t\t                    If you select exclude, these groups can use 1FA (all others need 2FA).\n\t\t                " : "\nWenn Ausschliessen ausgewählt, können diese Gruppen die einfache Authentifizierung verwenden (alle anderen benötigen die Zwei-Faktor-Authentifizierung).",
    "\n\t\t                    Exclude ip addresses\n\t\t                " : "\n\t\t Ausschliessen von IP-Adressen\n\t\t",
