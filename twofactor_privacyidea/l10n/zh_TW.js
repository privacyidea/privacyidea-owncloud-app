OC.L10N.register(
    ...
    "Failed to trigger challenges. Wrong HTTP return code: " : "無法觸發測驗。錯誤 HTTP 返回碼：",
    "Failed to trigger challenges." : "無法觸發測驗。",
    "Please confirm the authentication with your mobile device." : "請使用您的行動裝置確認驗證。",
