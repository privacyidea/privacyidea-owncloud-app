OC.L10N.register(
    ...
    "But we recommend to update your privacyIDEA server." : "Por rekomandojmë të përditësoni shërbyesin tuaj privacyIDEA.",
    "Verify" : "Verifikoje",
    "Alternate Login Options" : "Mundësi Alternative Hyrjeje",
    ...
    "User Realm" : "Hapësirë Përdoruesi",
    "\n                    Select the user realm, if it is not the default one.\n                " : "\n                    Përzgjidhni hapësirën e përdoruesit, nëse s’është ajo parazgjedhje.\n                ",
    "Preferred token type" : "Lloj i parapëlqyer token-ësh",
    "Select the token type, which should be used first if triggered." : "Përzgjidhni llojin e token-ëve që duhen përdorur të parët, nëse vjen puna.",
    ...
    "Ignore the system wide proxy settings and send authentication requests to privacyIDEA directly." : "Shpërfilli rregullimet për ndërmjetës, të vlefshme për krejt sistemin dhe dërgo kërkesa mirëfilltësimi drejt e te privacyIDEA.",
    "Test authentication by supplying username and password that are checked against privacyIDEA:" : "Testoni mirëfilltësimin duke dhënë emër përdoruesi dhe fjalëkalim që kontrollohen kundrejt privacyIDEA:",
    "User" : "Përdorues",
    "Password" : "Fjalëkalim",
    "Test" : "Provë",
    "Challenge Response" : "Përgjigje Pyetjes",
