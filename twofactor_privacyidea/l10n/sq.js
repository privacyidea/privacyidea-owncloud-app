OC.L10N.register(
    ...
    "\n                    Sets timeout to privacyIDEA for login in seconds.\n                " : "\n                    Cakton mbarim kohe për privacyIDEA për hyrje, në sekonda.\n                ",
    "Include or " : "Përfshi ose",
    "Exclude" : "Përjashto",
    " these groups from two factor authentication" : "këto grupe nga mirëfilltësimi dyfaktorësh",
    "\n                    If Include is selected, just the groups in this field need to do 2FA.\n                    If you select Exclude, these groups can use 1FA (all others need 2FA).\n                " : "\n                    Nëse është përzgjedhur përfshirja, vetëm për grupet në këtë fushë lypset të bëhet Mirëfilltësim Dyfaktorësh.\n                    Nëse përzgjidhni Përjashto, këto grupe mund të përdorim Mirëfilltësim Njëfaktorësh (krejt të tjerëve u duhet Mirëfilltësimi Dyfaktorësh).\n                ",
    ...
    "User Realm in privacyIDEA (other than default)" : "Përdor Realm në privacyIDEA (përveç parazgjedhjes)",
    "Test" : "Provë",
