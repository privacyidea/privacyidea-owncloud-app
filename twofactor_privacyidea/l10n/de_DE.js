OC.L10N.register(
    ...
    "But we recommend to update your privacyIDEA server." : "Wir empfehlen jedoch, Ihren privacyIDEA-Server zu aktualisieren.",
    ...
    "Please confirm the authentication with your mobile device or enter a valid otp." : "Bitte bestätigen Sie die Authentifizierung mit Ihrem Mobilgerät oder geben Sie eine gültige Einmalverschlüsselung (OTP) ein.",
    ...
    "\n\t\t                    You can either add single IPs like 10.0.1.12,10.0.1.13, a range like 10.0.1.12-10.0.1.113 or combinations like 10.0.1.12-10.0.1.113,192.168.0.15\n\t\t                " : "\n\t\t Sie können entweder einzelne IPs wie 10.0.1.12, 10.0.1.13, einen Bereich wie 10.0.1.12-10.0.1.113 oder Kombinationen wie 10.0.1.12-10.0.1.113, 192.168.0.15 hinzufügen.\n\t\t",
    "User Realm" : "Benutzer-Bereich",
    "\n                    Select the user realm, if it is not the default one.\n                " : "\nWählen Sie den Benutzerbereich aus, wenn es sich nicht um den Standardbereich handelt.",
    "\n                    Verify the SSL certificate.\n                " : "\nÜberprüfe das SSL-Zertifikat",
    "\n                        Do not uncheck this in productive environments!\n                    " : "\nBitte deaktivieren Sie dies nicht in einer produktiven Umgebung!",
