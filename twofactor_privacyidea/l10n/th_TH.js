OC.L10N.register(
    ...
    "Verify" : "ยืนยัน",
    "Alternate Login Options" : "<div></div>",
    ...
    "Ignore the system wide proxy settings and send authentication requests to privacyIDEA directly." : "ละเว้นการตั้งค่าพร็อกซีทั้งระบบและส่งคำขอตรวจสอบสิทธิ์ไปยัง privacyIDEA โดยตรง",
    "Test authentication by supplying username and password that are checked against privacyIDEA:" : "ทดสอบการรับรองความถูกต้องกับ PrivacyIDEA โดยระบุชื่อผู้ใช้และรหัสผ่าน:",
    "User" : "ชื่อผู้ใช้",
    "Password" : "รหัสผ่าน",
    "Test" : "ทดสอบ",
    ...
    "Let the user log in if the user is not found in privacyIDEA." : "อนุญาตให้ผู้ใช้ล็อกอินหากไม่พบผู้ใช้ใน privacyIDEA",
