OC.L10N.register(
    ...
    "Verify" : "Подтвердить",
    "Alternate Login Options" : "Альтернативные настройки входа",
    ...
    "Test authentication by supplying username and password that are checked against privacyIDEA:" : "Пробная аутентификация через указание имени пользователя и пароля, которые проверяются с помощью privacyIDEA:",
    "User" : "Пользователь",
    "Password" : "Пароль",
    "Test" : "Проверка",
