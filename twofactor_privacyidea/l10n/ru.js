OC.L10N.register(
    ...
    "Exclude these groups from two factor authentication" : "Исключить из двухфакторной аутентификации следующие группы",
    "\n                    Users in the following groups will not need to do two factor authentication.\n                    Please enter a comma separated list of group names.\n                " : "\nПользователям из следующих групп не потребуется проходить двухфакторную\nаутентификацию. Пожалуйста, вводите имена групп через запиятую.",
