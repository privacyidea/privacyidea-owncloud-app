OC.L10N.register(
    ...
    "Select the token type, which should be used first if triggered." : "Wählen Sie den Token-Typ aus, der bevorzugt verwendet werden soll, falls eine Challenge für diesen Typ ausgelöst wurde.",
